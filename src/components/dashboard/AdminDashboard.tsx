...
// Sample data
const recentUsers = [
  { id: 1, name: "User 1", joinDate: "Today", status: "Verified" },
  { id: 2, name: "User 2", joinDate: "Yesterday", status: "Pending" },
  { id: 3, name: "User 3", joinDate: "2 days ago", status: "Verified" },
];

const recentRecruiters = [
  { id: 1, company: "Company 1", joinDate: "Today", status: "Pending" },
  { id: 2, company: "Company 2", joinDate: "3 days ago", status: "Verified" },
  { id: 3, company: "Company 3", joinDate: "1 week ago", status: "Verified" },
];
