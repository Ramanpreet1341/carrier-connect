              ...
              <CardContent>
                ...
                <div className="mt-4 space-y-2">
                  {pipelineStages.new.map((candidate) => (
                    <div 
                      key={candidate.id} 
                      className="text-sm p-2 rounded-md bg-purple-50 cursor-pointer hover:bg-purple-100"
...
const recentApplications = [
  { id: 1, name: "Candidate 1", role: "Frontend Developer" },
  { id: 2, name: "Candidate 2", role: "UX Designer" },
  { id: 3, name: "Candidate 3", role: "Product Manager" },
];
...
const pipelineStages = {
  new: [
    { id: 1, name: "Candidate A", role: "Frontend Developer" },
    { id: 2, name: "Candidate B", role: "UX Designer" },
  ],
  assessment: [
    { id: 3, name: "Candidate C", role: "Frontend Developer" },
    { id: 4, name: "Candidate D", role: "Product Manager" },
  ],
  interview: [
    { id: 5, name: "Candidate E", role: "UX Designer" },
    { id: 6, name: "Candidate F", role: "Frontend Developer" },
  ],
  offer: [
    { id: 7, name: "Candidate G", role: "Product Manager" },
    { id: 8, name: "Candidate H", role: "Frontend Developer" },
  ]
};
