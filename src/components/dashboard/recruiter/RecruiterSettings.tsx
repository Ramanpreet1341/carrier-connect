            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="email" defaultValue="company@example.com" />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="location" defaultValue="City, State" />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-6">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      {[
                        { name: "Team Member 1", email: "member1@example.com", role: "Admin", status: "Active" },
                        { name: "Team Member 2", email: "member2@example.com", role: "Recruiter", status: "Active" },
                        { name: "Team Member 3", email: "member3@example.com", role: "Recruiter", status: "Active" },
                        { name: "Team Member 4", email: "member4@example.com", role: "Admin", status: "Active" },
                        { name: "Team Member 5", email: "member5@example.com", role: "Recruiter", status: "Invited" },
                      ].map((member, i) => (
