          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 space-y-6">
              <Card className="glass-card">
                ...
                <CardContent>
                  <p className="text-sm">
                    Company Name is a forward-thinking recruitment firm dedicated to connecting top talent with innovative companies. 
                    With years of experience in the recruitment space, our team understands the unique challenges of the industry and 
                    is committed to providing personalized solutions for both candidates and clients.
                  </p>
                  <p className="text-sm mt-4">
                    Our expertise spans across various domains including software development, product management, UI/UX design, data science, 
            ...
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    { name: "Team Member 1", title: "Recruiting Lead", email: "member1@example.com" },
                    { name: "Team Member 2", title: "Technical Recruiter", email: "member2@example.com" },
                    { name: "Team Member 3", title: "Talent Acquisition", email: "member3@example.com" },
                    { name: "Team Member 4", title: "HR Manager", email: "member4@example.com" },
                    { name: "Team Member 5", title: "Technical Recruiter", email: "member5@example.com" },
                  ].map((member, i) => (
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="website" placeholder="https://example.com" defaultValue="https://company.com" />
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea 
                    ...
                    rows={5}
                    defaultValue="Company Name is a leading recruitment firm connecting talented professionals with innovative companies across the industry. We pride ourselves on understanding both client and candidate needs to make the perfect match."
                  />
                </div>
